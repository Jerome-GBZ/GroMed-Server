...
public interface ICommandeEndpoint {
    ...
    @ApiOperation(value = "Ajouter une présentation au panier avec une quantité donnée")
    @ApiResponse(responseCode = "200", description = "OK")
    @ApiResponse(responseCode = "500", description = "Erreur serveur")
    @ApiResponse(responseCode = "404", description = "Commande ou présentation non trouvée")
    ...
    @ApiResponse(responseCode = "200", description = "OK")
    @ApiResponse(responseCode = "500", description = "Erreur serveur")
    @ApiResponse(responseCode = "404", description = "Commande ou présentation non trouvée dans la commande")
    ...
    @ApiResponse(responseCode = "200", description = "OK")
    @ApiResponse(responseCode = "500", description = "Erreur serveur")
    @ApiResponse(responseCode = "404", description = "Commande de l'utilisateur non trouvée")
    ...
    @ApiOperation(value = "Valider le panier de l'utilisateur, renvoie la premiere livraison")
    @ApiResponse(responseCode = "200", description = "OK")
    @ApiResponse(responseCode = "500", description = "Erreur serveur")
    @ApiResponse(responseCode = "404", description = "Problème lors de la validation")
    ...
    @ApiResponse(responseCode = "200", description = "OK")
    @ApiResponse(responseCode = "500", description = "Erreur serveur")
    @ApiResponse(responseCode = "404", description = "Problème lors de la récupération des détails de la commande")
